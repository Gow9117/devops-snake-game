...
class UserServiceTest {
    ...
    @Test
    @DisplayName("findByEmail returns empty Optional when absent")
    void findByEmail_NotFound() {
        when(userRepository.findByEmail("missing@e.com")).thenReturn(Optional.empty());
        assertThat(userService.findByEmail("missing@e.com")).isEmpty();
    }
    ...
    @Test
    @DisplayName("emailExists returns false for non-existing email")
    void emailExists_False() {
        when(userRepository.existsByEmail("ghost@e.com")).thenReturn(false);
        assertThat(userService.emailExists("ghost@e.com")).isFalse();
    }
